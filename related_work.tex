...
Software transactional memory was implemented in many other languages, including \Haskell~\citep{DBLP:conf/ppopp/HarrisMPH05}, \Scala~\citep{zio} and \Cpp~\citep{cpp_stm_free}.
