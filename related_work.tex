...
The implementations closest to our work are \Haskell's STM and \Scala's \ZIO. The STM runtime in within GHC is implemented in C, whereas \Scala has a pure-Scala implementation. Other works have considered compiler-level or bytecode-rewriting support, and may have better performance characteristics than pure-library implementations such as \Kcas.
